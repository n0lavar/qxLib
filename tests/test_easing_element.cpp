...
//
//!\brief       Tests for qx::base_easing_element
//!\details     ~
//
//!\author      Khrapov
//!\date        11.05.2021
...
protected:
    ...
    void CheckNotStarted()
    {
        ...
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get(), type(-1.0)));
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get_fraction(), type(0)));
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get_speed(), type(1)));
    }
    ...
    void CheckStarted(type fExpectedValue, type fExpectedFraction, type fExpectedSpeed = type(1.f))
    {
        ...
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get(), fExpectedValue, eps));
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get_fraction(), fExpectedFraction, eps));
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get_speed(), fExpectedSpeed, eps));
    }
    ...
    void CheckFinished(type fExpectedValue)
    {
        ...
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get(), fExpectedValue));
        EXPECT_TRUE(qx::meta::epsilon_equal(m_Element.get_fraction(), type(1.0)));
    }
...
<
    qx::base_easing_element<float>,
    qx::base_easing_element<double>,
    qx::base_easing_element<long double>
>;
...
TYPED_TEST(TestEasingElements, update_speed)
{
    ...
    EXPECT_TRUE(qx::meta::epsilon_equal(TestFixture::m_Element.update(TYPE(0.1)), TYPE(0.f)));
    TestFixture::CheckStarted(TYPE(-0.7l), TYPE(0.1l));

    EXPECT_TRUE(qx::meta::epsilon_equal(TestFixture::m_Element.update(TYPE(0.1)), TYPE(0.f)));
    TestFixture::CheckStarted(TYPE(-0.4l), TYPE(0.2l));

    EXPECT_TRUE(qx::meta::epsilon_equal(TestFixture::m_Element.update(TYPE(0.2)), TYPE(0.f)));
    ...
    EXPECT_TRUE(qx::meta::epsilon_equal(TestFixture::m_Element.update(TYPE(1.0)), TYPE(0.9f), TYPE(1e-7)));
    TestFixture::CheckFinished(TYPE(2.l));

    EXPECT_TRUE(qx::meta::epsilon_equal(TestFixture::m_Element.update(TYPE(1.0)), TYPE(1.f)));
    TestFixture::CheckFinished(TYPE(2.l));
}
...
TYPED_TEST(TestEasingElements, pause_resume)
{
    ...
    EXPECT_TRUE(qx::meta::epsilon_equal(TestFixture::m_Element.update(TYPE(0.1f)), TYPE(0.1f)));
    TestFixture::CheckPaused(TYPE(-0.7l), TYPE(0.1l));
