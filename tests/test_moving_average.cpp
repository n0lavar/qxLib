...
//
//!\brief       Tests for qx::moving_average
//!\details     ~
//
//!\author      Khrapov
//!\date        1.06.2021
...
TYPED_TEST(TestMovingAverageClass, values)
{
    ...
    {
        -0.246858119964599609375f,
        -3.8619120121002197265625f,
        -1.9051692485809326171875f,
         0.807511806488037109375f,
        -4.016750812530517578125f,
         4.8727092742919921875f,
         1.9572658538818359375f,
        -3.2410314083099365234375f,
         1.3986148834228515625f,
         0.652375698089599609375f,
         1.061019420623779296875f,
         4.963634490966796875f,
         3.29406642913818359375f,
        -3.274301052093505859375f,
        -3.18559932708740234375f,
         1.38341045379638671875f,
         1.851825714111328125f,
        -4.91829395294189453125f,
        -4.24566650390625f,
         4.6774921417236328125f
    };
    ...
    for (size_t i = 0; i < values.size(); ++i)
    {
        ...
        EXPECT_TRUE(qx::epsilon_equal(
            fAverage,
            TestFixture::m_MovingAverage.get()));
