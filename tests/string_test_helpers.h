...
#define StringTypeTn   typename qx::basic_string<typename TypeParam::value_type, TypeParam>
#define StringType     qx::basic_string<typename TypeParam::value_type, TypeParam>
...
#define StdStringArg   typename std::basic_string<ValueType, std::char_traits<ValueType>, std::allocator<ValueType>>
