...
#define IMPL_CONTAINER(container)                                                                                                               \
    ...
    reverse_iterator        rend            (void)                      { return reverse_iterator(this, static_cast<size_type>(-1));        }   \
    const_reverse_iterator  crbegin         (void)              const   { return const_reverse_iterator(this, size() - 1);                  }   \
    const_reverse_iterator  crend           (void)              const   { return const_reverse_iterator(this, static_cast<size_type>(-1));  }   \
                                                                                                                                                \
