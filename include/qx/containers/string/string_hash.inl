...
constexpr basic_string_hash<Traits>::basic_string_hash(const_pointer pString, size_type nSize) noexcept
    : m_nHash(Traits::hash_function(pString, Traits::hash_seed(), nSize))
{
}

template<class Traits>
constexpr basic_string_hash<Traits>::basic_string_hash(const_pointer pszString) noexcept
{
...
constexpr basic_string_hash<Traits>::basic_string_hash(const String& sString) noexcept
...
constexpr typename char_traits<value_type>::size_type fast_hash_string_traits<value_type>::hash_function(
